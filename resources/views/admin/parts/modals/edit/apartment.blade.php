<!-- Modal -->
<div class="modal fade" id="editApartment-{{$apartment->id}}" tabindex="-1" role="dialog"
     aria-labelledby="editApartment-{{$apartment->id}}" aria-hidden="true">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" id="tabContent">
                    <li class="active nav-item"><a class="nav-link"
                                                   href="#apartment_characteristics_edit{{$apartment->id}}"
                                                   data-toggle="tab"> Apartment Characteristics</a></li>
                    <li class=" nav-item"><a class="nav-link" href="#apartment_prices_edit{{$apartment->id}}"
                                             data-toggle="tab"> Apartment Prices</a></li>
                    <li class="nav-item"><a class="nav-link" href="#apartment_fee_edit{{$apartment->id}}"
                                            data-toggle="tab">Apartment Fee</a></li>
                    <li class="nav-item"><a class="nav-link" id="apartment_holder_button{{$apartment->id}}"
                                            href="#apartment_holder_edit{{$apartment->id}}" data-toggle="tab">Apartment
                            Holder</a></li>
                ...
                <form action="/admin/apartments/edit/{{$apartment->id}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="apartment_characteristics_edit{{$apartment->id}}">
                            <p class="attention_edit_apartment mt-5">All fields are optional. You can leave everything
                                as it is <i class="fas fa-exclamation-circle"></i></p>
                            <div class="form-group">
                                <label for="edit_map" class="ml-5 new_apartment_label"><u>Select address of the new
                                        apartment </u> &nbsp;<i class="fas fa-map-marked-alt"></i></label>
                            ...
                            <div class="row">
                                <div class="form-group ml-5 col-md-5">
                                    ...
                                    <input type="text" name="lat_2" id="lat2_{{$apartment->id}}"
                                           value="{{$apartment->lat}}" class="form-control" readonly>
                                </div>
                                <div class="form-group ml-4 col-md-5">
                                    <label for="lng" class="ml-5 new_apartment_label"><u>Longitude</u></label>
                                    <input type="text" name="lng_2" id="lng2_{{$apartment->id}}"
                                           value="{{$apartment->lng}}" class=" form-control" readonly>
                                </div>
                                <div class="form-group ml-5 col-md-5">
                                    <label for="edit_address" class=" new_apartment_label"><u> Address</u> <i
                                                class="fas fa-map-pin"></i></label>
                                    <input type="text" name="address" value="{{$apartment->location}}"
                                           class="edit_address form-control" placeholder="...">
                                </div>
                                <div class="form-group ml-4 col-md-5">
                                    <label for="edit_address" class=" new_apartment_label"><u> Name</u></label>
                                    <input type="text" name="apartment_name" value="{{$apartment->name}}"
                                           class="edit_address form-control" placeholder="...">
                                </div>
                                <div class="form-group ml-4 col-md-5 mt-3">
                                    <label for="stars" class="stars_label">Nr of Stars for the Apartment <i
                                                class="fas fa-star"></i></label>

                                    <span class="star_rating_edit row ml-5" style="margin-left: 100px !important;">
               <!--RADIO 1-->
                <input type='checkbox' class="radio_item" value="1" name="edit_stars"
                       {{$apartment->stars >=1 ? 'checked' :''}} id="el{{$apartment->id}}_1">
                    <label class="label_item" for="item_1"> &#9734 </label>

                                        <!--RADIO 2-->
                <input type='checkbox' class="radio_item" value="2" name="edit_stars"
                       {{$apartment->stars >=2 ? 'checked' :''}} id="el{{$apartment->id}}_2">
                <label class="label_item" for="radio2"> &#9734 </label>

                                        <!--RADIO 3-->
                <input type='checkbox' class="radio_item" value="3" name="edit_stars"
                       {{$apartment->stars >=3 ? 'checked' :''}} id="el{{$apartment->id}}_3">
                <label class="label_item" for="radio3"> &#9734 </label>


                                        <!--RADIO 4-->
                <input type='checkbox' class="radio_item" value="4" name="edit_stars"
                       {{$apartment->stars >=4 ? 'checked' :''}} id="el{{$apartment->id}}_4">
                <label class="label_item" for="radio4"> &#9734 </label>

                                        <!--RADIO 5-->
                <input type='checkbox' class="radio_item" value="5" name="edit_stars"
                       {{$apartment->stars >=5 ? 'checked' :''}} id="el{{$apartment->id}}_5">
                <label class="label_item" for="radio5"> &#9734 </label>
            </span>
                                </div>
                                <div class="col-md-5 mt-4">
                                <span class="ml-5  new_apartment_label "><u>Surface of the
                                        apartment</u></span>

                                    <div class="input-group ml-5 mt-3">
                                        <input type="number" step="0.01" min="0" name="surface"
                                               value="{{$apartment->surface}}" class="form-control col-md-3"
                                ...
                                <div class=" col-md-6">
                                    <label for="features" class="ml-2 mt-4 new_apartment_label"><u>Change the
                                            features of the Apartment</u></label>
                                    <div style="overflow: auto; height: 370px; width:250px; " class="mb-5 ml-5">
                                        ...
                                        @foreach($features as $feature)
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    ...
                                                    <input type="checkbox" name="new_features[]"
                                                           {{$old_feature>0 ? 'checked' :''}} value="{{$feature->id}}"
                                ...
                                <div class="col-md-5 " style="margin-top: 28px">
                                    <div class="form-group row">
                                        ...
                                        <input type="number" min="0" name="price" step="0.01"
                                               class="form-control ml-3 col-md-3"
                                               value="{{$apartment->price}}">
                                    </div>
                                    <div class="form-group " >
                                        <label   for="" class="new_apartment_label mt-1"><u> Elevator:</u></label>
                                        <input type="checkbox" class="mt-2 ml-3 " {{$apartment->elevator===1 ? 'checked' : ''}} name="elevator" value="1" >
                                    </div>
                                    <div class="form-group flex-group" >
                                        <label   for="" class="new_apartment_label mt-1"><u>Maximum Number of Guests:</u></label>
                                        <input type="number" step="1" min="0" class="form-control col-md-3 ml-3 " value="{{$apartment->nr_guests}}" name="nr_guests" required placeholder="...">
                                    </div>
                                    <div class="form-group flex-group" >
                                        <label   for="" class="new_apartment_label mt-1"><u> Number of Bedrooms:</u></label>
                                        <input type="number" step="1" min="0" class="form-control col-md-3  " value="{{$apartment->bedrooms}}" name="nr_bedrooms" placeholder="..." style="float: right">
                                    </div>
                                    <div class="form-group flex-group" >
                                        <label   for="" class="new_apartment_label mt-1"><u> Number of Bathrooms:</u></label>
                                        <input type="number" step="1" min="0" class="form-control col-md-3  float-right" value="{{$apartment->bathrooms}}" name="nr_bathrooms" placeholder="...">
                                    </div>
                                    <div class="form-group flex-group" >
                                        <label   for="" class="new_apartment_label mt-1"><u> Floor:</u></label>
                                        <input type="number" step="1" min="0" class="form-control col-md-3 " name="floor" value="{{$apartment->floor}}" placeholder="...">
                                    </div>
                                    <div class="form-group flex-group" >
                                        <label   for="" class="new_apartment_label mt-1"><u> Number of single Beds:</u></label>
                                        <input type="number" step="1" min="0" class="form-control col-md-3" value="{{$apartment->nr_single_beds}}" name="nr_single_beds" placeholder="...">
                                    </div>
                                    <div class="form-group flex-group" >
                                        <label   for="" class="new_apartment_label mt-1"><u> Number of double Beds:</u></label>
                                        <input type="number" step="1" min="0" class="form-control col-md-3  " value="{{$apartment->nr_double_beds}}" name="nr_double_beds" placeholder="...">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-10 ml-5">
                                    <label for="description" class="  new_apartment_label"><u>Description of the
                                            Apartment</u></label>
                                    <textarea name="description" id="" cols="30" rows="10" class="form-control wysiwyg">{!!  $apartment->description!!}
                                        ></textarea>
                                </div>
                            ...
                            <div class="row mb-4 ml-5">
                                    ...
                                    <label for="increment_price" class="mt-5 price_label"><u>With how much do you want
                                            to increment the price in time?</u></label>
                                <div class="col-md-6">
                                    <input type="number" min="0" name="increment_price"
                                           value="{{$apartment->increment_price}}" step="0.01"
                                           class="form-control col-md-3 float-right">
                                </div>
                                        <div class="col-md-4">
                                    <input type="radio" name="price_type"
                                           {{$apartment->kind_increment_price==="%" ? 'checked' :''}} value="%"
                                           class="lead">%
                                    <input type="radio" name="price_type" value="u.m."
                                           {{$apartment->kind_increment_price==="u.m." ? 'checked' :''}}  class="lead ml-4">u.m.
                                ...
                                <div class="row">
                                    @foreach($apartment_photo  as $apartment_photo)
                                        <div class="col-md-3 img_edit{{$apartment_photo->id}} ml-4">
                                            ...
                                            <a href='javascript:void(0)' onclick="removeImage({{$apartment_photo->id}})"
                                               class="delete_photo  btn btn-sm btn-danger btn-block mb-2"><i
                            ...
                            <div class="form-group col-md-5 mt-4 mt-5 ml-5">
                                <label for="photos_apartment " class="new_apartment_label"><u>Photos for the
                                        apartment</u></label>
                        ...
                        <div class="tab-pane" id="apartment_prices_edit{{$apartment->id}}">
                            <h1 class="new_apartment_label mt-5">
                                <center><u>Apartment Prices for a given period</u></center>
                            </h1>
                            <button type="button" class="btn btn-info ml-4 my-3" data-toggle="modal"
                                    data-target="#addApartmentCost{{$apartment->id}}">
                            ...
                            <div class="message_price" style="display: none;">
                                <div class=" @if(!empty($ap_id)) message_prices{{$ap_id->id}} @endif alert col-md-8 offset-2  alert-dismissible fade show"
                                     role="alert">
                                            ...
                                            <li>
                                                ...
                                                <div style="float: right">
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                            onclick="deleteApCost{{$apartment->id}}({{$apartment_cost->id}}) ">
                                                        Delete Price
                                                    </button>
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn btn-warning ml-3 btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#editPrice{{$apartment_cost->id}}">
                                                        Edit Price
                                                    </button>
                                                </div>
                                                <strong>Price : {{$apartment_cost->price}}</strong>&nbsp;
                                                <p class="cost_ap_info">Start date: <span
                                                            style="color: darkred"><strong>{{\Carbon\Carbon::parse($apartment_cost->start_date)->toDateString()}}</strong></span>
                                                </p>
                                                <p class="cost_ap_info">End date: <span
                                                            style="color: darkred"><strong>{{\Carbon\Carbon::parse($apartment_cost->end_date)->toDateString()}}</strong></span>
                                                </p>
                        ...
                        <div class="tab-pane" id="apartment_fee_edit{{$apartment->id}}">
                            ...
                            <button type="button" class="btn btn-info ml-4 my-3" data-toggle="modal"
                                    data-target="#addApartmentFee{{$apartment->id}}">
                            ...
                            <div class=" mt-2 ml-1 col-md-11" style="overflow-y: scroll; height: 400px;">
                                <div class="message_fee" style="display: none;">
                                    <div class=" @if(!empty($apfee_id)) message_fees{{$apfee_id->id}} @endif alert  alert-dismissible fade show"
                                         role="alert">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                        ...
                                        @foreach($apartment_fees as $apartment_fee)
                                            <div class="form-check">
                                                ...
                                                <li>
                                                    ...
                                                    <div style="float: right">
                                                        <button type="button"
                                                                onclick="deleteApFee{{$apartment->id}}({{$apartment_fee->id}})"
                                                                class="btn btn-danger btn-sm">Delete fee
                                                        </button>
                                                        <!-- Button trigger modal -->
                                                        <button type="button" class="btn btn-warning ml-3 btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#editApartmentFee{{$apartment_fee->id}}">
                                                            Edit Fee
                                                        </button>
                                                    </div>
                                                    <strong>{{$apartment_fee->name}}</strong>&nbsp;
                                                    <p>Value: &nbsp;<span style="color: darkred"><strong>{{$apartment_fee->value}}
                                                                &nbsp;&nbsp; {{$apartment_fee->type_of_value}}</strong></span>
                                                    </p>
                        ...
                        <div class="tab-pane" id="apartment_holder_edit{{$apartment->id}}">
                            ...
                            <p class="holder_warning "><u>If a holer is selected you can <strong>not </strong>enter a
                                    new one</u></p>

                            <ul class="nav nav-tabs" id="tabContent">
                                <li class="active nav-item"><a class="nav-link" href="#choose_holder{{$apartment->id}}"
                                                               data-toggle="tab"> Choose Holders</a></li>
                                <li class="nav-item"><a class="nav-link" href="#add_holder{{$apartment->id}}"
                                                        data-toggle="tab">Add new Holder</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="choose_holder{{$apartment->id}}">
                                    <p class=" text-danger  mt-5 ml-5">If you want to deselect an option keep <strong>ctrl</strong>
                                    </p>
                                    <div class=" mt-5 ml-5">
                                                ...
                                                @foreach($holders as $holder)
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input type="radio" name="holder" value="{{$holder->id}}"
                                                                   {{$apartment->holder_id===$holder->id ? 'checked' : ''}} class="holders{{$apartment->id}} form-check-input">{{$holder->name}}
                                                            <br>
                                                            {{$holder->email}}
                                                            <br>
                                                            <hr>
                                ...
                                <div class="tab-pane" id="add_holder{{$apartment->id}}">
                                    <div class="row ml-4 mt-5">
                                        <div class="form-group col-md-5 ">
                                            ...
                                            <input type="text" name="holder_name" id="holder_name{{$apartment->id}}"
                                                   placeholder="...." class="form-control">
                                        </div>
                                        <div class="form-group ml-5 col-md-5">
                                            <label for="address" class="holder_label_add">Address:</label>
                                            <input type="text" name="holder_address"
                                                   id="holder_address{{$apartment->id}}" placeholder="...."
                                                   class="form-control">
                                        </div>
                                        <div class="form-group  col-md-5">
                                            <label for="email" class="holder_label_add">Email:</label>
                                            <input type="email" name="holder_email" id="holder_email{{$apartment->id}}"
                                                   placeholder="...." class="form-control">
                                        </div>
                                        <div class="form-group ml-5 col-md-5">
                                            <label for="email" class="holder_label_add">Phone:</label>
                                            <input type="text" name="holder_phone" id="holder_phone{{$apartment->id}}"
                                                   placeholder="...." class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group  col-md-5">
                                            ...
                                            <label for="document_photo" class="holder_label_add">Add Document Photo
                                                <strong> (Optional)</strong></label>
                                            <label class="custom-file-upload"> <input class="custom_file_input"
                                                                                      id="document_photo{{$apartment->id}}"
                                                                                      type="file"
                                                                                      name="document_photo"/> <i
                                                        class="fas fa-upload"></i></label>
                                        </div>
                                        <div class="form-group  ml-5 col-md-5">
                                            <label for="document_photo" class="holder_label_add">Cnp
                                                <strong>(Optional)</strong></label>
                                            <input type="number" min="0" placeholder="...." name="cnp"
                                                   id="cnp{{$apartment->id}}" class="form-control">
                                        </div>
