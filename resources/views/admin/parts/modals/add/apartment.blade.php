        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" id="tabContent">
                    <li class="active nav-item"><a class="nav-link" href="#apartment_characteristics" data-toggle="tab">
                            Apartment Characteristics</a></li>
                    <li class="nav-item"><a class="nav-link" href="#apartment_price" data-toggle="tab">Apartment
                            Prices</a></li>
                    <li class="nav-item"><a class="nav-link" href="#apartment_fee" data-toggle="tab">Apartment Fee</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#apartment_holder" data-toggle="tab">Apartment
                            Holder</a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="apartment_characteristics">
                            <div class="form-group mt-5">
                                <label for="map" class="ml-5 new_apartment_label"><u>Select address of the new
                            ...
                            <div class="row">
                                ...
                                <div class="form-group ml-5 col-md-5">
                                    <label for="address" class=" new_apartment_label"><u> Address</u> <i
                                                class="fas fa-map-pin"></i></label>
                                    <input type="text" name="address" class="address form-control" placeholder="..."
                                           required>
                                </div>
                                <div class="form-group ml-3 col-md-5">
                                    <label for="address" class=" new_apartment_label"><u> Name of the apartment</u>
                                    </label>
                                    <input type="text" name="apartment_name" class=" form-control" placeholder="..."
                                           required>
                                </div>

                                <div class="form-group col-md-5 mt-3 ml-2">
           ...
           <!--RADIO 1-->
            ...
            <label class="label_item" for="radio5"> &#9734 </label>
                                ...
                                <div class="form-group col-md-6 ml-5">
                                    <label for="increment_price" class=" price_label"><u>With how much do you want to
                                            increment the price in time?</u></label>
                                    <input type="number" min="0" name="increment_price" step="0.01"
                                           class="form-control col-md-3 float-right" required>
                                </div>
                        ...
                        <div class="tab-pane" id="apartment_price">
                            <h1 class="new_apartment_label mt-5">
                                <center><u>Apartment Prices for specific periods</u></center>
                            </h1>
                            <button type="button" id="add_row_price" class="btn btn-primary mt-4"
                                    style="margin-left: 30px;">Add Price&nbsp;<i class="fas fa-plus"></i></button>
                            <button type="button" id="remove_row_price" class="btn btn-danger  mt-4  ml-2">Remove last
                                field of price&nbsp;&nbsp;<i class="fas fa-minus"></i></button>
                        ...
                        <div class="tab-pane" id="apartment_fee">
                            <h1 class="new_apartment_label mt-5">
                                <center><u>Apartment Fee</u></center>
                            </h1>
                            <button type="button" id="add_row_fee" class="btn btn-primary mt-4"
                                    style="margin-left: 30px;">Add Fee for&nbsp;the apartment&nbsp;<i
                                        class="fas fa-plus"></i></button>
                            <button type="button" id="remove_row_fee" class="btn btn-danger  mt-4  ml-2">Remove last
                                field&nbsp;&nbsp;<i class="fas fa-minus"></i></button>
                        ...
                        <div class="tab-pane" id="apartment_holder">
                            ...
                            <ul class="nav nav-tabs" id="tabContent">
                                <li class="active nav-item"><a class="nav-link" href="#choose_holder" data-toggle="tab">
                                        Choose Holders</a></li>
                                <li class="nav-item"><a class="nav-link" href="#add_holder" data-toggle="tab">Add new
                                        Holder</a></li>
                            </ul>
                            <div class="tab-content">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input type="radio" name="holder" value="{{$holder->id}}"
                                                                   class="holders form-check-input">{{$holder->name}}
                                                            <br>
                                                            {{$holder->email}}
                                                            <br>
                                                            <hr>
                                ...
                                <div class="tab-pane" id="add_holder">
                                    <div class="row ml-4 mt-5">
                                        ...
                                        <div class="form-group ml-5 col-md-5">
                                            ...
                                            <input type="text" name="holder_address" id="holder_address"
                                                   class="form-control" placeholder="...">
                                        </div>
                                        <div class="form-group  col-md-5">
                                            <label for="email" class="holder_label_add">Email:</label>
                                            <input type="email" name="holder_email" id="holder_email"
                                                   class="form-control" placeholder="...">
                                        </div>
                                        <div class="form-group ml-5 col-md-5">
                                            <label for="email" class="holder_label_add">Phone:</label>
                                            <input type="text" name="holder_phone" id="holder_phone"
                                                   class="form-control" placeholder="...">
                                        </div>
                                        ...
                                        <div class="form-group  ml-5 col-md-5">
                                            <label for="document_photo" class="holder_label_add">Cnp
                                                <strong>(Optional)</strong></label>
                                            <input type="number" min="0" placeholder="...." name="cnp" id="cnp"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
