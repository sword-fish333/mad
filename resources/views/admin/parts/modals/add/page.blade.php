    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header page_add_header">
                <h5 class="modal-title add_page_title_modal" id="exampleModalLabel">Add Page</h5>
                    ...
                    <div class="row ml-5 mt-4">
                        ...
                        <div class=" col-md-5" >
                            ...
                            <div class="form-group mt-3 ml-4">
                                ...
                                <textarea cols="16" rows="10" class="form-control" placeholder="..." required name="page_content"></textarea>
                            </div>
                        </div>
                    </div>
            </div>
